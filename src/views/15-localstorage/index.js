...
class LocalStorage extends Component {
    ...
    addItem = e => this.setState({ newItem: e.target.value })
    ...
    toggleDone = e => {
        ...
        const match = items.find((item, i) => i === parseInt(index))
        ...
        return (
            <Fragment>
                ...
                <div className="wrapper">
                    ...
                    <p />
                    <ul className="plates">
                        {items.length === 0 && <li>Loading Tapas...</li>}
                        {items.map((plate, i) => {
                            return (
                                <li key={i}>
                                    <input
                    ...
                    <form className="add-items" onSubmit={this.submitItem}>
                        <input
                            type="text"
                            name="item"
